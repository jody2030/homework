...
case 161...180:
    print("you are in the hard zone , activity in this zone increase maxmimum performance capacity for shorter sessions ")
case 181...200:
    print("you are in the maximum zone . activity in this zone helps fit athletes spped")
default:
